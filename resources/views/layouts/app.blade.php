        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-pills-soft">
                @if(auth()->user()->isAdmin())
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.workshops.*') ? 'active' : '' }}" href="{{ route('admin.workshops.index') }}"><i class="bi bi-building-gear me-1"></i>Workshops</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.payments.*') ? 'active' : '' }}" href="{{ route('admin.payments.index') }}"><i class="bi bi-cash-stack me-1"></i>Sales</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.subscriptions.*') || request()->routeIs('admin.subscription-plans.*') ? 'active' : '' }}" href="{{ route('admin.subscriptions.index') }}"><i class="bi bi-gem me-1"></i>Subscriptions</a></li>
                @else
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('customer.workshops.*') ? 'active' : '' }}" href="{{ route('customer.workshops.index') }}"><i class="bi bi-geo-alt me-1"></i>Workshops</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('customer.payments.*') ? 'active' : '' }}" href="{{ route('customer.payments.index') }}"><i class="bi bi-receipt me-1"></i>Payments</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('customer.subscriptions.*') ? 'active' : '' }}" href="{{ route('customer.subscriptions.index') }}"><i class="bi bi-gem me-1"></i>Subscription</a></li>
                @endif
            </ul>
